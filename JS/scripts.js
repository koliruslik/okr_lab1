...
function initAbilityCards() {
    ...
    if (cardDef) {
        ...
        cardDef.addEventListener("click", function(event) {
            ...
            battleLog(" Захист активовано! Поглинуто " + roll + " шкоди.", "info");
        });
    }
    ...
    if (breakBtn) {
        breakBtn.addEventListener("click", function() {
            ...
            breakBtn.textContent = "Кубик Долі вже зламано";
            breakBtn.disabled = true;
            battleLog("Кубик Долі зламано. Більше не відповідає на кліки.", "warn");
        });
    }
}
...
function combatSummonBoss() {
    ...
    battleLog("☠ " + boss + " з'явився! Тремти, герою.", "danger");
    triggerBossState();
}
